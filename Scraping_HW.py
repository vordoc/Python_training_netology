...
for article in articles:
    ...
    # main_preview_common = article.find_all('div', class_='article-formatted-body article-formatted-body_version-2')
    ...
    # main_preview_text = set([main_preview_text.find('p').text for main_preview_text in main_preview_common])
    main_text = set([main_text.text for main_text in main_common])

    # print(title_text)
    # print(categories_text)
    # # print(main_preview_text)
    # print(main_text)
    # print('-------------')
